...
function TecherApply() {
  return (
    ...
    <h1 className="text-xl font-bold text-white capitalize dark:text-white">Teacher Application Form</h1>
    <form>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                <label className="text-white dark:text-gray-200" for="passwordConfirmation">Faculty Id</label>
                <input id="number" type="number" className="block w-full py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
            </div>
            <div>
            ...
            <div>
                <label className="text-white dark:text-gray-200" for="passwordConfirmation">Address</label>
                <input id="text" type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
            </div>
            <div>
